...
//  Date	Who	Chg#	What
//
// 05nov14	mb		{5} fix PO RETRY LOCK error
// 03oct14	mb		{3a} incorp {3b} changes by rmd in 660 across to 710 :
//	20aug14	rmd	{3b}		retrieve territory (store) code associated with PO to
//						po-user-only-alpha4-1 allowing Territory address print
//
//	03sep14	mb	{4}		default printer for Kim of Geelong 
//	07aug14	mb		{3}		fix issue where only option to exit is to say YES to update email address.
//	28mar14	rmd	{2}		upgrade for 710
			...
			validation
				...
				*/
					...
					if lf-update-email = "Y"
						...
						/* // {3} //-- fix issue where only option to exit is to say YES to update email address.
						reenter lf-email-address
						*/ // {3}
					// < {3}
						set lf-original-email	= strconcat(na-name na-company)
...
// > {3}
		...
		/*
		display "Complete?:"     	@17,36 background 	//@17,66 background //{1}
		accept lf-complete			@17,47 			//@17,77                //{1}
		*/
			uppercase
			allowed "Y" "N"
			default "Y"
	...
	elseif lf-mode = "P"
		...
		//display "Choose Printer:"	@16,31 background   //{1}
// < {4}
...
*/
		...
		*/
		...
		/*
		display "Complete?:"     	@17,61 background 	//@17,66 background //{1}
		accept lf-complete			@17,72 			//@17,77                //{1}
		*/
			uppercase
			allowed "Y" "N"
			default "Y"
